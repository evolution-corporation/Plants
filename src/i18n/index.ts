...
class I18nCustom {
  ...
  public setLanguage(language: Language): void {
    ...
    const languageOptions: LanguagePage = this.languages[this.languages.findIndex(item => item.code == this.language)]
...
export default new I18nCustom([
  { code: Language.ru, libray: RU, name: 'Русский' }
])