...
import InSign from '../InSignSelectMethod';
...
export function AddUserInfo({
  ...
  return ( <
    ...
    initialRouteName = {
      isNoLogin ? 'InputLogin' : 'AddUserInfo'
    } // Узнаем, каких данных нет у пользователя и переводим на соответсвующую страницу
    >
    <
    Screen component = {
      InputLogin
